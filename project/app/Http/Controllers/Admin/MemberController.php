    ...
    public function datatables()
    {
         ...
         return DataTables::of($datas)
                            ...
                            ->addColumn('action', function(Member $data) {
                                return '<div class="action-list"><a data-href="' . route('admin-member-edit',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>'.__('Edit').'</a><a href="javascript:;" data-href="' . route('admin-member-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
