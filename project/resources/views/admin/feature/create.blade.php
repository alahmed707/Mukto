          ...
          <div class="col-lg-12">
              <div class="product-description">
                  <div class="body-area">
                      ...
                      <form id="geniusformdata" action="{{route('admin-feature-create')}}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <div class="img-upload">
                                      ...
                                      <p class="text">{{ __('Prefered Size: (150x150) or Square Sized Image') }}</p>
                                  </div>
