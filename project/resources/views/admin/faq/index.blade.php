            ...
            <div class="col-lg-12 px-5 pt-5">
                <div class="card mb-5">
                    <div class="card-header infos">
                        <h4 class="text-white text-uppercase mb-0">{{ __('Meta Informations') }}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                  <div class="img-upload">
                                      <div id="image-preview" class="img-preview" style="background: url({{ $data->faq_photo ? asset('assets/images/'.$data->faq_photo): asset('assets/images/noimage.png') }});">
