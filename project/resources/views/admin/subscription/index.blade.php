...
@section('content')  
<input type="hidden" id="headerdata" value="SUBSCRIPTION">
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">Vendor Subscription Plans</h4>
                <ul class="links">
                    <li>
                        <a href="{{ route('admin.dashboard') }}">Dashboard </a>
                    </li>
                    <li>
                        <a href="{{ route('admin-subscription-index') }}">Vendor Subscription Plans</a>
                    </li>
                </ul>
            </div>
        </div>
