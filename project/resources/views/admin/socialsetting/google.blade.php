                    ...
                    <div class="product-description">
                      <div class="body-area">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $data->g_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-social-googleup',1)}}" {{ $data->g_check == 1 ? 'selected' : '' }}>{{ __('Active') }}</option>
                                      <option data-val="0" value="{{route('admin-social-googleup',0)}}" {{ $data->g_check == 0 ? 'selected' : '' }}>{{ __('Deactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="Enter Client ID" name="gclient_id" value="{{ $data->gclient_id }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="Enter Client Secret" name="gclient_secret" value="{{ $data->gclient_secret }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="Enter Site URL" name="gredirect" value="{{url('/auth/google/callback')}}" readonly>
                          </div>
                        </div>
