...
@section('content')
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Post') }}<a class="add-btn ml-2" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                      ...
                      <form id="geniusform" action="{{route('admin-blog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="{{ ($data->meta_tag == null && strip_tags($data->meta_description) == null) ? "showbox":"" }}">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                                <textarea class="input-field" name="meta_description" placeholder="{{ __('Details') }}">{{ $data->meta_description }}</textarea> 
                            </div>
                          </div>
                        </div>
