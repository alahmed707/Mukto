...
@section('content')  
<input type="hidden" id="headerdata" value="CALLBACK">
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Callback Section') }}</h4>
                <ul class="links">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin-ps-callback.index') }}">{{ __('Callback Section') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <p class="text-center">{{ __('You are about to delete this Request.') }}</p>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-callback-datatables') }}',
               columns: [
