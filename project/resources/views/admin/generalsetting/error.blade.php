...
<div class="content-area">
  <div class="mr-breadcrumb">
      <div class="row">
          <div class="col-lg-12">
              <h4 class="heading">{{ __('Error Page') }}</h4>
              <ul class="links">
                  <li>
                  ...
                  <div class="body-area">
                      ...
                      <form id="geniusform" action="{{route('admin-gs-update')}}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <textarea class="nic-edit" name="error_title" placeholder="{{ __('Title') }}">
                                      {!! $gs->error_title !!}
                                  </textarea>
                              </div>
                          </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <textarea class="nic-edit" name="error_text" placeholder="{{ __('Details') }}">
                                      {!! $gs->error_text !!}
                                  </textarea>
                              </div>
                          </div>
