							...
							<div class="product-description">
								...
								<form id="geniusformdata" action="{{ route('admin.staff.store') }}" method="POST" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-lg-7">
											<input type="email" class="input-field" name="email" placeholder="{{ __('Email') }}" required="" value="">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-7">
											<input type="text" class="input-field" name="phone" placeholder="{{ __('Phone') }}" required="" value="">
										</div>
									</div>
