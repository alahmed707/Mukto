...
<div class="content-area">
  <div class="mr-breadcrumb">
      <div class="row">
          <div class="col-lg-12">
              <h4 class="heading">{{ __('Edit Language') }} <a class="add-btn" href="{{route('admin-lang-admin-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
              <ul class="links">
                  <li>
                  ...
                  <li>
                      <a href="{{ route('admin-lang-admin-edit',$data->id) }}">{{ __('Edit') }}</a>
                  </li>
              </ul>
          </div>
      </div>
          ...
          <div class="col-lg-12">
              <div class="product-description">
                  <div class="body-area">
                      ...
                      <form id="geniusform" action="{{route('admin-lang-admin-update',$data->id)}}" method="POST" enctype="multipart/form-data">
