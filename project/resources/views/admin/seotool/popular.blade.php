                ...
                <div class="mr-table allproduct">
                    ...
                    <div class="table-responsiv">
                        <table id="example" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($productss as $productt) @foreach($productt as $prod)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br> @if($prod->product->subcategory_id != null) {{$prod->product->subcategory->name}}
                                        <br> @if($prod->product->childcategory_id != null) {{$prod->product->childcategory->name}} @endif @endif
                                    </td>
                                    <td>
                                        {{$prod->product->type}}
                                    </td>
