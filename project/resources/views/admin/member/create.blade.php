                  ...
                  <div class="body-area">
                      ...
                      <form id="geniusformdata" action="{{route('admin-member-create')}}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="twitter" placeholder="{{ __('Twitter URL') }}" value="">
                              </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="col-lg-4">
                                  <div class="left-area">
                                      <h4 class="heading">{{ __('Linkdedin URL') }} *</h4>
                                      <p class="sub-heading">({{ __('In Any Language') }})</p>
                                  </div>
                              </div>
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="subtitle" placeholder="{{ __('Linkdedin URL') }}" value="">
                              </div>
                          </div>
