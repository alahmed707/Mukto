...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Team Section') }}</h4>
                <ul class="links">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin-member-index') }}">{{ __('Team Section') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="team_subtitle" value="{{ App\Models\Pagesetting::findOrFail(1)->team_subtitle }}" placeholder="Enter Subtitle" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="team_title" value="{{ App\Models\Pagesetting::findOrFail(1)->team_title }}" placeholder="Enter Title" required>
                                    </div>
                                </div>
                            </div>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('admin-member-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
